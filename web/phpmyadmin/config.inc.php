 ...
 */
$urlabsdyn=$_SERVER["HTTP_HOST"];
$cfg['PmaAbsoluteUri'] = 'http://'.$urlabsdyn.'/phpmyadmin';
...
$i++;
$cfg['Servers'][$i]['host']          = 'm5c1.icodia.com'; // MySQL hostname or IP address
...
$cfg['Servers'][$i]['user']          = 'allergologuelet';      // MySQL user
$cfg['Servers'][$i]['password']      = 'Ezs8EbHm';          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = array('allergologuelet');          // If set to a db-name, only
...
$cfg['ThemeDefault']        = 'arctic_ocean';         // set up default theme, if ThemePath not empty

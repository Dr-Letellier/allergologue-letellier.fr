...
body {
    ...
    background-image:    url('<?php echo ( (isset($pma_http_url) && !empty($pma_http_url)) ? $pma_http_url : '../' ); ?>phpmyadmin/themes/arctic_ocean/img/wbg_left.jpg');
...
td.heada, span.heada {
    background-image:    url(<?php echo ( (isset($pma_http_url) && !empty($pma_http_url)) ? $pma_http_url : '../' ); ?>phpmyadmin/themes/arctic_ocean/img/b_sdb.png);
